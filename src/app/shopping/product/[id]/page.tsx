...
async function ProductPage({ params: { id } }: Props) {
  ...
  // If no product data is found, return the NotFound Component
    ...
    <div className="p-12 pt-0">
      ...
      <section className="flex flex-col lg:flex-row mt-5 md:mt-0">
        <div className="md:p-10 md:pl-0 mx-auto">
          ...
          {/* Display more product images in a horizontal scroll */}
            ...
            {productData.content.pricing.online[0].details && (
              <>
                ...
                <div className="flex space-x-4">
                  ...
                  {/* Display a message if there are more pricing options available */}
            ...
            {productData.content.reviews.top_review && (
              <div className="border p-5 rounded-lg mt-2">
                <div className="flex space-x-1">
                  ...
                  <h5>
                    &ldquo;{productData.content.reviews.top_review.title}&ldquo;
                  </h5>
                </div>
...
// This code fetches product details based on the product ID, then displays various sections of information about the product, including its title, rating, images, pricing details, description, highlights, reviews, and specifications. It also includes some conditional rendering based on the availability of certain data.