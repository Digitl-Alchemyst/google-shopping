                    ...
                    {pageResult?.content?.results?.organic?.map((item) => (
                        <Link 
                            ...
                            <div className="border-b p-5 flex-1">
                                <p className="text-sky-400 text-lg font-bold ">{item.title}</p>
                            </div>
                            <div className="px-5 py-2 not-italic">
                                <p className="text-lime-700 font-medium">{item.price_str} {item.currency}</p>
                                <p className="text-sky-500 font-semibold">{item.merchant.name}</p>
                            </div>
                        </Link>                        
                    ))}
